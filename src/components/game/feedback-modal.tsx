        ...
        <AnimatePresence>
            ...
            >
                <motion.div
                    ...
                    className={`
                        relative w-full max-w-md p-5 md:p-8 border-[3px] md:border-[4px] border-black text-center
                ...
                >
                    ...
                    <h3 className={`text-2xl md:text-3xl font-bold mb-2 md:mb-4 ${type === "correct" ? "text-green-800" : "text-red-800"}`}>
                        {type === "correct" ? "Acertou!" : "Opa!"}
                    </h3>

                    <p className="text-base md:text-xl text-zinc-700 mb-4 md:mb-6">{message}</p>
